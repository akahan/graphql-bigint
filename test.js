...
const GraphQLBigInt = require('./index');
...
graphql(schema, invalidQuery1)
  ...
  .then(({data, errors}) => {
    expect(errors).to.have.lengthOf(1);
    expect(errors[0].message).to.equal('Variable "$input3" got invalid value { num: 9007199254740992 }; Expected type BigInt at value.num; BigInt cannot represent non 53-bit signed integer value: 9007199254740992');
